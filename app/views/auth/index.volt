...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    {{ form('class': 'login-form' ,'action':'auth/login','style':'margin-top: 130px;') }}
    ...
    {{ form('class': 'register-form' ,'action':'auth/register') }}
    {{ register_form.render('csrf', ['value': security.getToken()]) }}
    <div id='messages'>
