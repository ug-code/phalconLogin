                            ...
                            <ul class="nav navbar-nav pull-right">
                                ...
                                <li class="dropdown dropdown-user dropdown-dark">
                                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                        ...
                                        <span class="username username-hide-mobile"><?= $this->auth->getName() ?></span> </a>
                                        ...
                                        <div class="profile-sidebar">
                                            ...
                                            <div class="portlet light profile-sidebar-portlet ">
                                                ...
                                                <div class="profile-usertitle">
                                                    <div class="profile-usertitle-name"> <?= $this->auth->getName() ?> </div>
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane active" id="tab_1_3">
                                                                    <?= $this->tag->form(['class' => 'change-password-form', 'action' => 'auth/changePassword']) ?>
                                                                    ...
                                                                    <div class="margin-top-10">
                                                                        <?= $this->tag->submitButton(['Change Password', 'class' => 'btn green']) ?>
                                                                    </div>
                                                                    <?= $this->tag->endForm() ?>
                                                                </div>
